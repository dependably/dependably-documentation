...
| [MCP server](mcp/index.md) | Connect Claude Desktop, Claude Code, Cursor, VS Code and other MCP clients to the registry with the read-only `dependably-mcp` server, and what each of its fourteen tools answers |
